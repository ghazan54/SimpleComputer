...
const int bigChars[][2]
    = { { 0x8181817E, 0x7E818181 }, { 0x40485060, 0x40404040 }, { 0x2040423C, 0x7E040810 },
...
int I_restartsc(void)
{
    ...
    return setitimer(ITIMER_REAL, &nval, &oval) || I_printall() || CU() || sc_regInit() || sc_regSet(err_ignoring_clock_pulses, 1);
}
